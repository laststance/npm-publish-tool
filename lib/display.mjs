...
export function logCompletion() {
  ...
  console.log(chalk.white('1. Configure Trusted Publishing on npmjs.com:'))
  console.log(
    chalk.gray(
  ...
  console.log(chalk.white('2. Make sure Git working tree is clean'))
  console.log(chalk.white('3. Run: npm run push-release-commit'))
  console.log(
...
export function logPackageManager(pmInfo) {
  console.log(
    chalk.cyan('📦 Detected package manager: ') +
      chalk.white(`${pmInfo.name} (${pmInfo.version})`),
  )
}
